  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-center">
      ...
      <div className="space-x-4">
        ...
        <Link href="/campaign/new"><button className="bg-blue-600 text-white px-4 py-2 rounded-xl">➕ Create</button></Link>
        <Link href="/roi"><button className="bg-green-600 text-white px-4 py-2 rounded-xl">📈 ROI</button></Link>
        <Link href="/notifications"><button className="bg-yellow-500 text-white px-4 py-2 rounded-xl">🔔 Alerts</button></Link>
